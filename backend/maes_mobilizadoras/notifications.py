...
def send_push_notification(token: str, title: str, body: str, data: Optional[Dict[str, str]] = None) -> bool:
    """
...
def send_to_user(user_id: str, title: str, body: str, data: Optional[Dict[str, str]] = None) -> int:
    """
